...
var commonController = exports.commonController = /*#__PURE__*/function () {
  ...
  return _createClass(commonController, null, [{
    key: "getAll",
    value: function () {
      var _getAll = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(collection, limit) {
        var page,
          sortValue,
          _resolvePagination,
          safeLimit,
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              _resolvePagination = (0, _pagination.resolvePagination)(limit, page), safeLimit = _resolvePagination.limit, safePage = _resolvePagination.page, offset = _resolvePagination.offset; // Total documents (for pagination)
              _context.n = 1;
            ...
            case 1:
              ...
              throw new _graphql.GraphQLError("You must select an available page number", {
                extensions: {
                  statusCode: 400
                }
              });
            case 2:
              _context.n = 3;
              return collection.find({}).sort(sortValue).limit(safeLimit).skip(offset).lean();
            case 3:
              data = _context.v;
              return _context.a(2, {
                data: data,
