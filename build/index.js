...
var _generalSchema = require("./services/common/generalSchema");
var _generalResolver = require("./services/common/generalResolver");
      ...
      while (1) switch (_context.n) {
        case 0:
          federatedSchema = buildSubgraphSchema([{
            typeDefs: _generalSchema.typeDefs,
            resolvers: _generalResolver.resolvers
        ...
        case 1:
          ...
          PORT = process.env.JAMAPA_GRAPHQL_PORT || 4000; //Server start
